...
<html>
    ...
    <body>
        ...
        $target_dir = "uploads/";
        $target_file = $target_dir . basename($_FILES["uploadedfileemail"]["name"]);
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["uploadedfileemail"]["tmp_name"], $target_file)) {
                echo "The file " . basename($_FILES["uploadedfileemail"]["name"]) . " has been uploaded. <br />";
            } else {
        ...
        $params = array(
            ...
            'html' => "<html xmlns=\"http://www.w3.org/1999/xhtml\" data-dnd=\"true\">
        <head>
        <title></title>
