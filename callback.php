...
<body>
    ...
    // if (isset($_SERVER['X-HELLOWORKS-SIGNATURE'])) {
    ...
    $hw_id = $json->id;
    // echo("$hw_id is the hw_id");
//    $document_hash = $json->document_hashes->{'signer_step.Form-nRJ3Vpnhm7'};
    $form_name = "signer_step.Form-nRJ3Vpnhm7";


//    $audit_trail_hash = $json->audit_trail_hash;
    // echo("$audit_trail_hash is the audit_trail_hash");
    // start form section for v2 HelloWorks API Callback
...
//    $to - new \SendGrid\Contacts\Recipient("Alex", "Griffen", "alex@alexgriffen.com");
//    $cc = new SendGrid\Contacts\Recipient("Ram", "muthukrishnan", "rammuthukrishnan7391@gmail.com");
//    $from = new SendGrid\Contacts\Recipient("HelloWorks Platform", "", "alex@alexgriffen.com");
...
//        $content = new SendGrid\Content("text/html", "<p>Here's the JSON in the HelloWorks callback for $hw_instance_id</p><br /><br /><p>$json_pretty</p>");
//    $content = new SendGrid\Mail\Content("text/html", "<p>Here's the JSON in the HelloWorks callback for $hw_instance_id</p><br /><br /><p>$json_pretty</p>");
//    $attachment0 = new SendGrid\Mail\Attachment("$file0_encoded", "application/pdf", "$workflow_id.pdf");
...
//    $attachment1 = new SendGrid\Mail\Attachment("$file1_encoded", "application/pdf", "$workflow_id.audit_trail.pdf");
